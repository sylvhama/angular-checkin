...
app.run ['$rootScope', '$route', '$anchorScroll', '$window', ($rootScope, $route, $anchorScroll, $window) ->
  ...
  $rootScope.$on '$routeChangeSuccess', (event, next, current) ->
    ...
    if typeof $route.current.$$route != 'undefined'
      $rootScope.activeMenu = $route.current.$$route.activeMenu
    else
      $rootScope.activeMenu = 'none'
]